...
public class DaysInMonthP4 {
    ...
    public static void main(String[] args)//main method
    {
        ...
        int y = sc.nextInt();
        isLeapYear(y);//static method calling directly by ita name
        System.out.println(isLeapYear(y));
        System.out.println("Enter month  to get days of that month");
        int k=sc.nextInt();
        getDaysInMonth(k,y);
        sc.close();
}
